...
#define TRXN_BEACON_START  (TRXN_HEADER_START + TRXN_HEADER_SZ)
...
#define TRXN_DATA_SZ1  (TRXN_BEACON_SZ+TRXN_SRVPORT_SZ+TRXN_SENDER_SZ+TRXN_RECEIVER_SZ+TRXN_AMOUNT_SZ)
